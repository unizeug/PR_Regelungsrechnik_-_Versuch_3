...
\begin{quote}
    ...
    \begin{quote}
        ...
        Sprungantwort reagiert mit einem etwas geringeren Überschwingen als das lineare Modelle mit der selben
        Totzeit.\\
        \vspace{1em}
    ...
    \begin{quote}
        ...
        Bei dieser Simulation wurde ein Smith-Prädiktor hinzugefügt. Er zeigt seine Aufwirkung auf die
        Sprungantwort, in dem sie weicher verläuft und überhaupt nicht mehr überschwingt. Diese Sprungantwort hat den
        besten verlauf, der bis hierher betrachteten Sprungantworten.\\
        \vspace{1em}
    ...
    \begin{quote}
        ...
        ein überschwingen zu erkennen. Das ist auch nicht verwunderlich, da unter anderem die Totzeit bei diesem Regeler
        nur angenähert wurde, während die Totzeit beim Smith-Prädiktor durch ein ``Delay''-Block dargestellt wurde, der
...
\begin{quote}
    ...
    \begin{quote}
        \TODO{SICHER??? simulation: start bei $30^{\circ}$ sprung um $31^{\circ}$}
